...
#
from BackTestBaseYF import *


class BackTestLongOnlyYF(BackTestBaseYF):
    ...
    def run_mean_reversion_strategy(self, SMA, threshold):
        ''' Back-testing a mean reversion-based strategy.
...
if __name__ == '__main__':
    ...
    lobt = BackTestLongOnlyYF('AAPL.O', '2010-1-1', '2019-12-31', 10000,
                              verbose=False)
    run_strategies()
